...
export const STATIC_FOODS_DATABASE: FoodItem[] = [
  ...
  {
    name: "Beef (Steak, Roast & Ground Beef)",
    p_rating: "High",
    mgPer100g: "120-150mg",
    category: "Meats",
    why: "Red meats like beef significantly elevate serum uric acid levels and carry a high risk of triggering painful acute gout flares. Strongly advised to avoid or strictly restrict. (Mayo Clinic, PubMed)"
  },
  {
    name: "Pork (Chops, Ribs & Tenderloin)",
    p_rating: "High",
    mgPer100g: "120-160mg",
    category: "Meats",
    why: "Pork contains dense concentrations of animal purines and saturated fats that exacerbate joint inflammation and elevate blood urate. Recommended to avoid or strictly limit. (Cleveland Clinic, Healthline)"
  },
  ...
  // ==========================================
  {
    name: "White Fish (Cod, Halibut, Tilapia, Flounder)",
    p_rating: "Moderate",
    mgPer100g: "90-115mg",
    category: "Seafood",
    why: "White fish such as cod, halibut, haddock, and tilapia contain moderate purines and are much leaner than oily small fish. Safe in controlled portions (75–100g) when steamed or baked. (Cleveland Clinic, PubMed)"
  },
  {
    name: "Salmon",
    p_rating: "Moderate",
